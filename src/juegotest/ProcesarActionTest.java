...
/*
 *El metodo processAction(Action action): String
 *devuelve una cadena que resonde a la accion que se desea ejecutar.
 *Pero si esa accion corresponde a una que finaliza el juego (condicion de endgame)
 *y la accion fue exitosa (true en el parametro boolean achieved
 *de la action, modificado en el proceso de respuesta),
 *la cadena devuelta se remplaza por la que describe ese final del juego.
 *Ademas, se concatena a la respuesta la cadena "\nFIN.".
 */

public class ProcesarActionTest {
	...
	@Test
	public void irALocationActual_noTieneEfecto() {
		//En este caso ya habria ocurrido la condicion de fin la primera vez que se fue al lugar
	...
	@Test
	public void irAPuntoCardinalSinAcceso_noEsFinDeJuego() {
	...
	@Test
	public void irADirection_NoSePuedeIr_noEsFinDeJuego() {
		expected = "No puedes ir hacia alla."; 
		//Ir al norte	
	...
	public void eliminarObstaculoConTrigger() {
		...
		/*
		 * SI EL TRIGGER FUNCIONA, PODREMOS IR A LA TABERNA
		 * ESA ES UNA CONDICION DE FIN DE JUEGO
		 * POR LO TANTO, EL RETORNO SERA CORRESPONDIENTE 
	...
	public void irALocation_SePuedeIr() {
		...
		/*
		 * ESTE RESULTADO ES EL DE FIN DE JUEGO
